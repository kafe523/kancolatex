...
from ..item.item import Item, ItemBuilder
from .... import const
from ....const import FleetType, ShipType
from ..aerial_combat.anti_air_cut_in import AntiAirCutIn
from ..interface.ship_base import ShipBase
from ..aerial_combat.shoot_down_info import ShootDownInfo
from ..item.item_bonus import ItemBonusStatus, getTotalBonus, bonusData
...
class Ship(ShipBase):
    ...
    level: int = 0
    displayStatus: ShipDisplayStatus = field(default_factory=ShipDisplayStatus)
    itemBonusStatus: ItemBonusStatus = field(default_factory=ItemBonusStatus)
